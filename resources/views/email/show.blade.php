                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <h1>{{$title}}</h1>
                            <p><img width="100%" src="{{ $message->embed(public_path() . '/images/beterontbijttafel.jpg')}}" alt=""/></p><!-- /hero -->
                            <p>{{$intro}}</p>
                        </td>
                    </tr>
                </table>
                    ...
                    <table bgcolor="">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>{{$paragraph->body}}</p>
                                @if($paragraph->link)
                                    <a class="btn alignr" href="{{$paragraph->link}}">Ga naar&raquo;</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p>Phone: <strong>408.341.0600</strong><br/>
                                                                    Email: <strong><a href="emailto:Jacques@hotmail.com">Jacques@hotmail.com</a></strong></p>
