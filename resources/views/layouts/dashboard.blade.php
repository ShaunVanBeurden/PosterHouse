                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (request()->is('*analytics') ? 'class="active"' : '') }}>
                            <a href="{{ route('dashboard.analytics') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Google
                                Analytics</a>
                        </li>
                        <li {{ (request()->is('*posts') ? 'class="active"' : '') }}>
                            <a href="{{ route('dashboard.post') }}"><i class="fa fa-map-signs fa-fw"></i> Posts</a>
                        </li>
                        <li {{ (request()->is('*users') ? 'class="active"' : '') }}>
                            <a href="{{ route('dashboard.users') }}"><i class="fa fa-users fa-fw"></i> Users</a>
                        </li>
                        <li {{ (request()->is('*units') ? 'class="active"' : '') }}>
                            <a href="{{ route('units.index') }}"><i class="fa fa-map fa-fw"></i> Units</a>
                        </li>
                        <li {{ (request()->is('*units') ? 'class="active"' : '') }}>
                            <a href="{{ route('sponsors.index') }}"><i class="fa fa-question fa-fw"></i> Sponsoren</a>
                        </li>
                        <li {{ (request()->is('*units') ? 'class="active"' : '') }}>
                            <a href="{{ route('newsletters.index') }}"><i class="fa fa-newspaper-o fa-fw"></i> Newsletters</a>
                        </li>
                        <li>
